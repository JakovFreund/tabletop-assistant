...
public class DefaultAction extends Castable {
    public DefaultAction(CastableType castableType, boolean ritual, boolean concentration, Ability savingThrow,
            ...
            List<StatusEffect> appliesStatusEffects, List<String> description) {

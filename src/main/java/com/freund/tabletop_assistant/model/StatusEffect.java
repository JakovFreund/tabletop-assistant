...
public enum StatusEffect {
    ...
    ARMS_OF_HADAR("Can't take Reactions", List.of()),
    ...
    BANISHED("Banished from this plane of existance. Incapacitated, can't move or be targeted", List.of()),
    ...
    BLACK_TENTACLES("Restrained by dark tendrils. Disadvantage on Attack Rolls. Affected entity can't move and takes 3d6 Bludgeoning damage per turn. Attack Rolls against the affected entity have Advantage. Strength Saving Throw to get out.", List.of()),
    BLADE_WARD("Resistant to Bludgeoning, Piercing, and Slashing damage.", List.of()),
    ...
    BLINDED("Disadvantage on Attack Rolls. Ranged attacks and spells have a range of 10 ft. Unaffected by Illusion spells. Attack Rolls against the affected entity have Advantage.", List.of()),
    ...
    BLINKED_TO_THE_ETHEREAL_PLANE("Affected entity is in the Ethereal Plane, where it can't be harmed, seen, or affected. Can't move or interact with anything in the world, but can choose to teleport up to 20ft.", List.of()),
    ...
    BRACED("On Damage Rolls, roll twice and use the higher result.", List.of()),
    ...
    CALL_LIGHTNING("Can Call Lightning without expending a spell slot.", List.of()),
    ...
    CHARMED("Can't attack spellcaster. Spellcaster has Advantage on Charisma Checks in dialogue.", List.of()),
    ...
    CLOAK_OF_SHADOWS("Advantage on Attack Rolls and imposes Disadvantage on enemy Attack Rolls. Attacking, casting spells, or entering a brightly lit area ends this condition.", List.of()),
    COCOONED("Trapped in a spider's web. Incapacitated and can't move. Condition ends upon taking damage or making a successful Strength Saving Throw.", List.of()),
    ...
    COMMAND_APPROACH("Incapacitated. Must move toward the spellcaster by the shortest route possible.", List.of()),
    COMMAND_DROP("Incapacitated. Must drop whatever it is holding.", List.of()),
    COMMAND_FLEE("Incapacitated. Must move away from the spellcaster by the fastest means possible.", List.of()),
    COMMAND_GROVEL("Incapacitated and can't move. Must drop Prone.", List.of()),
    COMMAND_HALT("Incapacitated and can't move.", List.of()),
    ...
    CONTAGION_BLINDING_SICKNESS("Blinded. Disadvantage on Wisdom Checks and Wisdom Saving Throws.", List.of()),
    ...
    DAZED("Disadvantage on Wisdom Saving Throws, can't take Reactions, and loses the Dexterity bonus to their Armour Class. Removed when Helped.", List.of()),
    ...
    DOWNED("Death Saving Throws must be rolled each turn. Any damage received while unconscious counts as one failure. Can be removed by healing or when Helped.", List.of()),
    ...
    ENTHRALLED("Peripheral vision reduced. Will keep looking at the spellcaster.", List.of()),
    ...
    EXHAUSTED_5("Can't move.", List.of()),
    ...
    FEARFUL("Disadvantage on Ability Checks and Attack Rolls. Affected entity must run from the source of its fear and can't take any additional actions. It makes a Saving Throw to shake off this effect if its turn is ended out of sight from the source of fear.", List.of()),
    ...
    FEIGNING_DEATH("Sunk into a deep magical coma. Incapacitated and can't move. Resistant to all damage except Psychic damage.", List.of()),
    ...
    FLESH_TO_STONE("Affected entity can't move as its body begins to petrify over the course of 3 turns. Attack Rolls against it have Advantage, while the entity's Attack Rolls and Dexterity Saving Throws have Disadvantage.", List.of()),
    ...
    FRENZIED("In Rage. Can use Frenzied Strike and Enraged Throw. When Frenzy ends, suffers one level of exhaustion.", List.of()),
    ...
    FRIENDS("Advantage on Charisma Checks directed at the affected entity.", List.of()),
    FRIGHTENED("Can't move. Disadvantage on Ability Checks and Attack Rolls.", List.of()),
    ...
    GRAPPLED("Can't move. Condition ends if the grappler is Incapacitated or an effect removes the grappled creature from the reach of the grappler, such as when a creature is hurled away by the thunderwave spell.", List.of()),
    ...
    HIDEOUS_LAUGHTER("Incapacitated and can't move. Prone. Disadvantage on Strength and Dexterity Saving Throws. At the end of its turn or when it takes damage, affected entity makes a Wisdom Saving Throw to end the condition.", List.of()),
    HOLD_MONSTER("Incapacitated and can't move. Automatically fails all Strength and Dexterity Saving Throws. Attack Rolls against the entity have Advantage. Melee attacks against the entity are always Critical Hits.", List.of()),
    HOLD_PERSON("Incapacitated and can't move. Automatically fails all Strength and Dexterity Saving Throws. Attack Rolls against the entity have Advantage. Melee attacks against the entity are always Critical Hits.", List.of()),
    ...
    HYPNOTIC_GAZE("Incapacitated and can't move. Spellcaster has Advantage on Ability Checks in dialogue. Removed upon taking damage. Duration can be extended with Maintain Hypnotic Gaze", List.of()),
    HYPNOTIZED("Incapacitated and can't move. Removed by taking damage, being Shoved, or Helped", List.of()),
    INCAPACITATED("Can't take Actions, Bonus Actions or Reactions. If Concentrating, lose Concentration.", List.of()),
    ...
    INVISIBLE("Advantage on Attack Rolls. Attack Rolls against affected entity have Disadvantage. Invisibiliy ends early if the invisible entity attacks, casts a spell, interacts with an object, takes an Action or Bonus Action, or is damaged.", List.of()),
    INVULNERABLE("Immune to all damage. Can still be afflicted with status effects.", List.of()),
    IRRESISTIBLE_DANCE("Can't move or take Actions. Disadvantage on Attack Rolls and Dexterity Saving Throws. Attack Rolls against the affected entity have Advantage.", List.of()),
    ...
    LETHARGIC("Consumed by exhaustion in the aftermath of Haste. Incapacitated and can't move.", List.of()),
    ...
    MAIMED("Can't move. Disadvantage on Dexterity Saving Throws. Removed by healing.", List.of()),
    ...
    NATURES_WRATH("Can't move. Disadvantage on Attack Rolls and Dexterity Saving Throws. Attack Rolls against the affected entity have Advantage.", List.of()), // TODO remove and change spell description to "Restrain"
    ...
    PARALYZED("Incapacitated and can't move or speak. Automatically fails Strength and Dexterity Saving Throws. Attack Rolls against the affected entity have advantage. Melee attacks against the creature are always Critical Hits", List.of()),
    ...
    PETRIFIED("Incapacitated, can't move or speak, and is unaware of its surroundings. Automatically fails Strength and Dexterity Saving Throws. Resistance to all damage, immunity to poison and disease.", List.of()),
    ...
    PHANTASMAL_KILLER("Can't move and takes 4d10 + 1d10 per upcast level Psychic damage per turn. Disadvantage on Ability Checks and Attack Rolls.", List.of()),
    ...
    PRONE("Disadvantage on Attack Rolls. Melee attacks against the creature have Advantage. Ranged attacks against the creature have Disadvantage. Crawling costs double movement. Can spend half its maximum Movement speed to stand up.", List.of()),
    ...
    RAGE("Deals additional damage with melee and improvised weapons. Damage amount depends on level. Resistant to physical damage, Advantage on Strength Checks and Saving Throws. Can't cast or concentrate on spells. Rage ends early if the barbarian hasn't attacked an enemy or taken damage since their last turn.", List.of()),
    RAGE_BOAR("Becomes Enlarged. Deals an additional 2 Slashing damage. Resistant to physical damage, Advantage on Strength Checks and Saving Throws. Can't cast or concentrate on spells. Rage ends early if the boar hasn't attacked an enemy or taken damage since their last turn.", List.of()),
    RAGE_BEAR_HEART("In Rage. Can use Unrelenting Ferocity. Resistant to all damage types except Psychic.", List.of()),
    RAGE_EAGLE_HEART("In Rage. Can use Diving Strike. Can use Dash as a Bonus Action. Opportunity Attacks against the affected entity have Disadvantage.", List.of()),
    RAGE_ELK_HEART("In Rage. Can use Primal Stampede. Movement speed increased by 15 ft.", List.of()),
    RAGE_TIGER_HEART("In Rage. Can use Tiger's Bloodlust. Jump distance increased by 15 ft.", List.of()),
    RAGE_WOLF_HEART("In Rage. Can use Inciting Howl. Allies have melee Advantage against enemies within 7ft of affected entity.", List.of()),
    ...
    RESTRAINED("Can't move. Disadvantage on Attack Rolls and Dexterity Saving Throws. Attack Rolls against the affected entity have Advantage.", List.of()),
    ...
    SHOCKED("Can't take reactions. Disadvantage on Ability Checks and Saving Throws using Dexterity.", List.of()),
    SHOCKING_GRASP("Can't take reactions.", List.of()),
    ...
    STAGGERED("Can't take Reactions.", List.of()),
    // STEP_OF_THE_WIND ??
    STONESKIN("Resistant to physical (Bludgeoning, Piercing, and Slashing) damage.", List.of()),
    STUNNED("Incapacitated. Can't move. Automatically fails Strength and Dexterity Saving Throws.", List.of()),
    ...
    SURPRISED("Can't move, take Actions or Reactions.", List.of()),
    ...
    TURNED("Must run as far away from caster as it can, and can't take any additional actions. Condition ends upon taking damage.", List.of()),
    UMBRAL_SHROULD("Invisible if obscured in shadows.", List.of()),
    UNCONSCIOUS("Paralyzed and Prone. Unaware of surroundings. Drops whatever it's holding.", List.of()),
    ...
    WITCH_BOLT("Linked to caster. Caster can use an Action to recast the spell and deal 1d12 Lightning damage.", List.of()),

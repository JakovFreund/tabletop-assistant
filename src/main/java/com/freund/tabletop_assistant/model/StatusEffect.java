...
public enum StatusEffect {
    ...
    EXHAUSTED_2("Movement Speed halved.", List.of()),
    EXHAUSTED_3("Disadvantage on Attack Rolls and Saving Throws.", List.of()),
    EXHAUSTED_4("HP maximum halved.", List.of()),
    EXHAUSTED_5("Can't move.", List.of(StatusEffect.IMMOBILE)),

public class TurnResource { // or just Resource because HP isn't a turn resource
    ...
    String cost; // name of TurnResource, on combat simulation loop through player's actions and
                 // remove 1 cost
...
enum RefillRate { // action, bonus action, reaction, movespeed, spellslots, class actions (action
                  // surge, rage)
    TURN,
    SHORT_REST,
